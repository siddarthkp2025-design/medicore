...
import { LayoutGrid, List, DoorOpen, Plus } from 'lucide-react';
      ...
      <PageHeader
        ...
        action={
          <div className="flex items-center gap-3">
            ...
            {isAdmin && (
              <Button onClick={() => navigate('/rooms/new')} className="bg-primary-700 hover:bg-primary-800 text-xs">
              ...
              >
                <CardContent className="p-4">
                  ...
                  <div className="mt-3 pt-2 border-t border-slate-100 flex justify-between items-center text-xs">
                    <span className="text-slate-400 text-2xs">Tariff</span>
